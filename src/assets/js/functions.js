...
jQuery(function ($) {
    ...
    $(function () {
        $tooltip.tooltipster({
            ...
            offset: [0, 0],
            animation: 'fade',
            content:'Klik hier om te sluiten of Druk op ESC!',
            delay: 20,
    ...
    $("#price-slider-lucht").owlCarousel({
        items: 1,
        autoplay: false,
        smartSpeed: 1500,
        autoplayHoverPause: true,
    ...
    $('#toggle > span').click(function() {
        ...
        $('#price-slider-zee').toggle(ix === 0);
        $('#price-slider-lucht').toggle(ix === 1);
      });
